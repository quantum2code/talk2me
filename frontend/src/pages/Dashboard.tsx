...
export default function MainPage() {
  ...
  const avatarURL = "/assets/girl-avatar.png";
      ...
      <aside className="w-64 bg-[#1a0030] p-5 flex flex-col justify-between rounded-tr-2xl rounded-br-2xl z-20 relative">
        <div>
          ...
          <nav className="space-y-3">
            <button className="w-full text-left px-4 py-2 rounded-lg bg-[#6d48ff] text-white font-semibold">
              Chat
            </button>
        ...
        <div className="bg-[#6d48ff] text-white p-4 rounded-xl text-center">
          ...
          <button className="bg-white text-[#6d48ff] px-4 py-1.5 rounded-full text-xs font-semibold">
            Upgrade now →
          </button>
        </div>
      </aside>
      ...
      <main className="relative flex-1 flex flex-col items-center justify-between px-4 pt-10 pb-8 overflow-visible">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 z-30">
          {[
            ...
            <div
              key={idx}
              className="bg-[#1e1e2f] text-white p-4 rounded-xl text-center w-52 cursor-pointer hover:bg-[#292943] transition"
            >
              {text}
            </div>
          ))}
        ...
        <div className="relative flex flex-col items-center justify-center mt-auto mb-4 w-40 h-40 z-30">
          ...
          <p className="text-sm text-gray-300 mt-4 z-30">
            ...
            <div className="bg-[#1a0030] p-8 rounded-2xl w-[90%] max-w-lg text-left relative shadow-2xl border border-[#6d48ff]">
              ...
              {popupStep === 1 && (
                <>
                  <h2 className="text-2xl font-bold mb-2 text-white">
                    How would you like your AI speech feedback?
                  </h2>
                  <p className="text-sm text-gray-400 mb-4">
                    Choose a style that suits you best. You can change this
                    anytime in settings.
                  </p>
                    ...
                    {[
                      ...
                      <label key={option} className="block text-white">
                        <input
                          ...
                          onChange={() =>
                            handleCheckboxChange(option, setFeedbackStyle)
                          }
                        />
                        {option}
                      </label>
                  ...
                  <div className="flex justify-between mt-6">
                    ...
                    <button
                      ...
                      className="bg-[#6d48ff] text-white px-4 py-2 rounded-full hover:bg-[#7b5fff]"
                    >
                      Next
                    </button>
                  </div>
              ...
              {popupStep === 2 && (
                <>
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    Help us tailor your practice session to match your goals.
                  </p>
                  <div className="space-y-2">
                    {[
                      ...
                      <label key={option} className="block text-white">
                        <input
                          ...
                          onChange={() =>
                            handleCheckboxChange(option, setSpeakingGoal)
                          }
                        />
                        {option}
                      </label>
